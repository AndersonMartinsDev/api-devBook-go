...
// AtualizarSenha alterar senha de um usuário
func AtualizarSenha(w http.ResponseWriter, r *http.Request) {
	...
	if usuarioIDNoToken != usuarioID {
		respostas.Erro(w, http.StatusUnauthorized, errors.New("você não pode alterar a senha de outro usuário"))
		return
	}
	...
	if erro = seguranca.VerificarSenha(senhaSalvaNoBanco, senha.Atual); erro != nil {
		respostas.Erro(w, http.StatusUnauthorized, errors.New("A Senha atual não é igual a salva"))
		return
	}
